    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden font-sans">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/auth">
              <Button variant="outline" className="bg-[#3ecf8e] hover:bg-[#3ecf8e]/90 text-[#000] font-semibold text-sm h-9 px-4 rounded-md shadow-sm">
                Entrar
              </Button>
            </Link>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <section className="flex flex-col items-center text-center py-10 md:py-20 space-y-8">
          ...
          >
            O CRM da Fort Secure foi criado para otimizar a gestão de vendas. Acompanhe oportunidades, gerencie clientes e analise dados em tempo real com uma interface moderna e eficiente.
          </motion.p>
        </section>
